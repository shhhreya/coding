...
const BASE_URL= 'https://superherospi.com/api.php/${SUPERHERO_TOKEN}'

const generate = (id, name) => {
   // const superHero = document.getElementById('superHero')
    fetch(`${BASE_URL}/${id}`)
    .then(response => response.json())
    .then(json => document.querySelector('body').innerHTML += `<img src="${json.image.url}" height=200 width=200/>`)
